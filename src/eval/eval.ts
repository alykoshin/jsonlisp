 ...
 * vocabulary externalized into the action table (see ARCHITECTURE.md for
 * the clause-by-clause mapping onto jmc.lisp's eval.).
 */
...
import { series, seriesn } from './evlis';
