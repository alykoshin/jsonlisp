...
(print (quote (10 10) ) )*/
  ...
  'test-list': [
    ...
    [
      'print',
      "list. In LISP empty list evaluates to NIL, so I'm not sure what has to correspond to it here (next test case fails because of it",
    ],
    //
  ...
  'test-length': [
    ...
    [
      'assert-equal',
      ['length', ['list']],
      ['$sbcl-to-list', '(length (list))'],
    ],
    [
      'assert-equal',
      ['length', ['list', 1]],
      ['$sbcl-to-list', '(length (list 1))'],
    ],
    [
      'assert-equal',
      ['length', ['list', 1, 2, 3]],
      ['$sbcl-to-list', '(length (list 1 2 3))'],
    ],
  ],
  ...
  'test-nth': [
    ...
    [
      'assert-equal',
      ['nth', 1, ['list', 11, 22, 33, 44]],
      ['$sbcl-to-list', '(nth 1 (list 11 22 33 44))'],
    ],
  ],
  ...
  'test-cdr': [
    ...
    [
      ...
      ['$sbcl-to-list', '(cdr (list 11 22 33 44))'],
    ],
  ],
  ...
  'test-nthcdr': [
    ...
    [
      'assert-equal',
      ['nthcdr', 2, ['list', 11, 22, 33, 44]],
      ['$sbcl-to-list', '(nthcdr 2 (list 11 22 33 44))'],
    ],
  ],
  ...
  'test-first': [
    ...
    [
      'assert-equal',
      ['first', ['list', 11, 22, 33, 44]],
      ['$sbcl-to-list', '(first (list 11 22 33 44))'],
    ],
  ],
  ...
  'test-consp': [
    ...
    [
      'assert-equal',
      ['consp', ['list', 11]],
      ['$sbcl-to-list', '(consp (list 11))'],
    ],
    [
      'assert-equal',
      ['consp', ['list', 11, 22]],
      ['$sbcl-to-list', '(consp (list 11 22))'],
    ],
  ],
  ...
  'test-listp': [
    ...
    [
      'assert-equal',
      ['listp', ['list', 11]],
      ['$sbcl-to-list', '(listp (list 11))'],
    ],
    [
      'assert-equal',
      ['listp', ['list', 11, 22]],
      ['$sbcl-to-list', '(listp (list 11 22))'],
    ],
  ],
};
