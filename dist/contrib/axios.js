...
const $axios = async function (_, args, { evaluate, logger }) {
    let [method, url, body] = (0, validate_args_1.validateArgs)(args, { exactCount: [2, 3] });
    (0, sexpr_1.ensureString)((method = await evaluate(method)));
    (0, sexpr_1.ensureString)((url = await evaluate(url)));
    if (body) {
        (0, sexpr_1.ensureString)((body = await evaluate(body)));
        try {
