...
const printer_1 = require("../eval/printer");
/**
 * @module sb-posix
 *
...
const setenv = async function (_, params, st) {
    ...
    (0, validate_args_1.validateArgs)(params, { exactCount: [3] });
...
const getcwd = async function (_, params, { logger }) {
    (0, validate_args_1.validateArgs)(params, { exactCount: 0 });
    const res = process.cwd();
    logger.debug((0, printer_1.stringify)(res));
    return res;
};
