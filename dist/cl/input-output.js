...
exports.actions = {
    ...
    terpri: async function (action, params, { evaluate, logger }) {
        ...
        (0, printer_1.print)(printer_1.EOL);
    ...
    prin1: async function (action, params, { evaluate, logger }) {
        ...
        const toPrint = (0, printer_1.stringify)(pValue);
        (0, printer_1.print)(toPrint);
        return pValue;
    },
    /** @name princ */
    ...
    'y-or-n-p': async function (_, args, { evaluate, logger }) {
        (0, validate_args_1.validateArgs)(args, { exactCount: [0, 1] });
